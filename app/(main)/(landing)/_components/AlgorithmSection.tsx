      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1D4533] tracking-tight">
            ...
            <span className="text-[#5E3122]">Hyper-Tuned Island Virality</span>
          </h2>
        ...
        <div className="flex justify-center mb-10">
          <div className="bg-white p-1 rounded-md border border-[#5E3122]/15 shadow-2xs flex space-x-1">
            <button
              ...
              className={`px-4 sm:px-5 py-2 rounded-md text-xs sm:text-sm font-semibold transition-all flex items-center space-x-2 cursor-pointer ${
                activeTab === "creators"
                  ...
                  : "text-[#5E3122] hover:bg-[#F7EAE0]/50"
              }`}
            >
              <TrendingUp size={15} />
          ...
          <AnimatePresence mode="wait">
            {activeTab === "creators" && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className="bg-white rounded-lg p-6 sm:p-8 border border-[#5E3122]/15 shadow-2xs grid grid-cols-1 lg:grid-cols-12 gap-8 items-center"
              >
                <div className="lg:col-span-7">
                  <span className="text-[#1D4533] font-bold text-xs uppercase tracking-wider block mb-1">
                    Uncapped Local Reach
                  </span>
                  <h3 className="text-2xl sm:text-3xl font-extrabold text-[#1D4533] mb-3">
                    Zero Follower Barriers. Pure Organic Discoverability.
                  </h3>
                  <p className="text-[#5E3122] leading-relaxed mb-5 font-normal text-sm sm:text-base">
                  ...
                  <ul className="space-y-2.5">
                    <li className="flex items-center text-sm font-medium text-[#5E3122]">
                      <CheckCircle2
                        size={16}
                        className="text-[#1D4533] mr-2 shrink-0"
                      />
                ...
                <div className="lg:col-span-5 bg-[#F7EAE0]/50 p-6 rounded-lg border border-[#F9D2BA]">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs font-bold text-[#1D4533] uppercase tracking-wider">
                      VIRAL MATCH SCORE
                    </span>
                    <Flame className="text-[#1D4533]" size={18} />
                  </div>
                  <div className="text-4xl sm:text-5xl font-extrabold text-[#1D4533] mb-2">
                    98.4%
                  </div>
                  <p className="text-xs text-[#5E3122]">
                    High local resonance detected based on regional audio trends
                    and authentic hashtag clustering.
                  </p>
                  <div className="mt-5 pt-3 border-t border-[#5E3122]/15 flex justify-between text-xs text-[#5E3122] font-semibold">
                    <span>Target: Caribbean Archipelago</span>
                    <span className="text-[#1D4533]">Status: Boost Active</span>
                  </div>
                </div>
              </motion.div>
            )}
              ...
              >
                ...
                <div className="lg:col-span-5 bg-[#F7EAE0]/50 p-6 rounded-lg border border-[#F9D2BA]">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Sparkles className="text-[#1D4533]" size={18} />
                  </div>
                  <div className="text-2xl font-extrabold text-[#1D4533] mb-3">
                    Pure Island Vibration
                  </div>
                  <div className="space-y-2 text-xs text-[#5E3122]">
                    <div className="flex justify-between py-1.5 border-b border-[#5E3122]/10 font-medium">
                      <span>Soca & Reggae Riddims</span>
                      <span className="text-[#1D4533] font-bold">45%</span>
                    </div>
                    <div className="flex justify-between py-1.5 border-b border-[#5E3122]/10 font-medium">
                      <span>Local Street Food & Culture</span>
                      <span className="text-[#1D4533] font-bold">30%</span>
                    </div>
                    <div className="flex justify-between py-1.5 border-b border-[#5E3122]/10 font-medium">
                      <span>Island Comedy & Sketches</span>
                      <span className="text-[#1D4533] font-bold">25%</span>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="lg:col-span-5 bg-[#F7EAE0]/50 p-6 rounded-lg border border-[#F9D2BA]">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Briefcase className="text-[#1D4533]" size={18} />
                  </div>
                  <div className="text-4xl sm:text-5xl font-extrabold text-[#1D4533] mb-2">
                    3.4x
                  </div>
                  ...
                  <div className="mt-5 pt-3 border-t border-[#5E3122]/15 flex justify-between text-xs text-[#5E3122] font-semibold">
                    ...
                    <span className="text-[#1D4533]">100% Caribbean</span>
                  </div>
                </div>
              </motion.div>
            )}
        ...
        <div className="bg-white rounded-lg p-6 sm:p-8 border border-[#5E3122]/15 shadow-2xs max-w-4xl mx-auto">
          <div className="flex items-center space-x-3 mb-6">
            <div className="p-2 bg-[#F7EAE0] text-[#1D4533] rounded-md border border-[#F9D2BA]">
              <Sliders size={20} />
            </div>
            <div>
              <h3 className="text-xl font-bold text-[#1D4533]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-xs font-bold text-[#5E3122] uppercase mb-1.5">
                  Starting Followers:{" "}
                  <span className="text-[#1D4533] font-extrabold">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-white border border-[#5E3122]/20 text-[#5E3122] rounded-md p-2.5 text-xs font-semibold focus:border-[#1D4533] outline-none"
                >
            ...
            {/* Results Display */}
            <div className="bg-[#F7EAE0]/40 p-5 rounded-md border border-[#F9D2BA] flex flex-col justify-between space-y-3">
              <div>
                <p className="text-xs text-[#5E3122]/70 font-semibold uppercase">
                  Legacy Network Reach
                </p>
                <p className="text-base font-semibold text-[#5E3122]/60 line-through">
                  ~{globalReachEstimate.toLocaleString()} Views
                </p>
              </div>

              <div className="pt-3 border-t border-[#5E3122]/15">
                <div className="flex items-center space-x-2">
                  <span className="text-xs font-bold text-[#1D4533] uppercase">
                    CMP Local Discovery Reach
                  </span>
                  <span className="bg-[#1D4533] text-white text-[10px] px-2 py-0.5 rounded-sm font-bold">
                    8.5x LIFT
                  </span>
                </div>
                <p className="text-3xl sm:text-4xl font-extrabold text-[#1D4533] mt-1">
                  ~{cmpReachEstimate.toLocaleString()}{" "}
                  <span className="text-sm text-[#5E3122] font-semibold">
                    Views
                  </span>
                </p>
                <p className="text-[11px] text-[#5E3122]/80 mt-1">
